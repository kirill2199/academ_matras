...
namespace backend\modules\DeliveryMethod\controllers;

use common\models\DeliveryMethod;
use backend\modules\DeliveryMethod\models\DeliveryMethodSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DefaultController implements the CRUD actions for DeliveryMethod model.
 */
class DefaultController extends Controller
{
    ...
    {
        if (($model = DeliveryMethod::findOne(['id' => $id])) !== null) {
            return $model;
        }
