...
class ProductSearch extends Product
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'slug', 'sku', 'currency', 'main_image', 'images', 'brand', 'model', 'country', 'manufacturer', 'barcode', 'seo_title', 'seo_description', 'seo_keywords', 'created_at', 'updated_at', 'published_at', 'reviews'], 'safe'],
