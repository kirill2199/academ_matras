                    ...
                    <div class="product-info-img aos-init aos-animate" data-aos="fade-right">
                        <div class="swiper product-top swiper-initialized swiper-horizontal swiper-backface-hidden">                            
                            <div class="swiper-wrapper" id="swiper-wrapper-cf4adff28d1c4a08" aria-live="polite">
                                <div class="swiper-slide slider-top-img swiper-slide-active" role="group"
                                    aria-label="1 / 10" data-swiper-slide-index="0"
                                    style="width: 537px; margin-right: 10px;">
                                    <img src="/images/placeholder.jpg" alt="img">
                                </div>
                                <div class="swiper-slide slider-top-img swiper-slide-next" role="group"
                                    aria-label="2 / 10" data-swiper-slide-index="1"
                                    style="width: 537px; margin-right: 10px;">
                                    <img src="/images/placeholder.jpg"
                                        alt="img">
                                </div>
                                <div class="swiper-slide slider-top-img" role="group" aria-label="3 / 10"
                                    data-swiper-slide-index="2" style="width: 537px; margin-right: 10px;">
                                    <img src="/images/placeholder.jpg"
                                        alt="img">
                                </div>
                                <div class="swiper-slide slider-top-img" role="group" aria-label="4 / 10"
                                    data-swiper-slide-index="3" style="width: 537px; margin-right: 10px;">
                                    <img src="/images/placeholder.jpg"
                                        alt="img">
                                </div>
                                <div class="swiper-slide slider-top-img" role="group" aria-label="5 / 10"
                                    data-swiper-slide-index="4" style="width: 537px; margin-right: 10px;">
                                    <img src="/images/placeholder.jpg"
                                        alt="img">
                                </div>
                                <div class="swiper-slide slider-top-img" role="group" aria-label="6 / 10"
                                    data-swiper-slide-index="5" style="width: 537px; margin-right: 10px;">
                                    <img src="/images/placeholder.jpg"
                                        alt="img">
                                </div>
                                <div class="swiper-slide slider-top-img" role="group" aria-label="7 / 10"
                                    data-swiper-slide-index="6" style="width: 537px; margin-right: 10px;">
                                    <img src="/images/placeholder.jpg"
                                        alt="img">
                                </div>
                                <div class="swiper-slide slider-top-img" role="group" aria-label="8 / 10"
                                    data-swiper-slide-index="7" style="width: 537px; margin-right: 10px;">
                                    <img src="/images/placeholder.jpg"
                                        alt="img">
                                </div>
                                <div class="swiper-slide slider-top-img" role="group" aria-label="9 / 10"
                                    data-swiper-slide-index="8" style="width: 537px; margin-right: 10px;">
                                    <img src="/images/placeholder.jpg"
                                        alt="img">
                                </div>
                                <div class="swiper-slide slider-top-img" role="group" aria-label="10 / 10"
                                    data-swiper-slide-index="9" style="width: 537px; margin-right: 10px;">
                                    <img src="/images/placeholder.jpg"
                                        alt="img">
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="swiper-wrapper" id="swiper-wrapper-1d91010349a8443387" aria-live="polite"
                                ...
                                <div class="swiper-slide slider-bottom-img swiper-slide-visible swiper-slide-active swiper-slide-thumb-active"
                                    role="group" aria-label="1 / 3" data-swiper-slide-index="0"
                                    style="width: 127.25px; margin-right: 10px;">
                                    <img src="/images/placeholder.jpg" alt="img">
                                </div>
                                <div class="swiper-slide slider-bottom-img swiper-slide-visible swiper-slide-next"
                                    role="group" aria-label="2 / 3" data-swiper-slide-index="1"
                                    style="width: 127.25px; margin-right: 10px;">
                                    <img src="/images/placeholder.jpg" alt="img">
                                </div>
                                <div class="swiper-slide slider-bottom-img swiper-slide-visible" role="group"
