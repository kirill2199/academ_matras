...
namespace frontend\modules\MenuItem\models;
...
class MenuItemSearch extends MenuItem
{
    ...
    {
        return [
            [['id', 'menu_id', 'parent_id', 'sort_order', 'status', 'category_id'], 'integer'],
            [['title', 'url', 'route', 'params', 'icon', 'target', 'rel', 'css_class', 'description', 'created_at', 'updated_at', 'item_type'], 'safe'],
        ];
    }
