...
namespace frontend\modules\MenuItem\controllers;

use common\models\MenuItem;
use frontend\modules\MenuItem\models\MenuItemSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DefaultController implements the CRUD actions for MenuItem model.
 */
