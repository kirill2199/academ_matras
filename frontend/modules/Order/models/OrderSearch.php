...
class OrderSearch extends Order
{
    ...
    {
        return [
            [['id', 'user_id', 'status', 'payment_status'], 'integer'],
            [['number', 'payment_method', 'delivery_method', 'customer_name', 'customer_email', 'customer_phone', 'delivery_address', 'delivery_city', 'delivery_region', 'delivery_country', 'delivery_postcode', 'currency', 'customer_comment', 'admin_comment', 'created_at', 'updated_at', 'paid_at', 'completed_at', 'cancelled_at', 'ip_address', 'user_agent', 'tracking_number'], 'safe'],
            [['delivery_price', 'subtotal', 'tax_amount', 'discount_amount', 'total', 'exchange_rate', 'weight_total'], 'number'],
        ];
    }
