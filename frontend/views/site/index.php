...
<section id="hero" class="hero">
    <div
        ...
        <div class="swiper-wrapper hero-wrapper" id="swiper-wrapper-1d1bcef4acfb2779" aria-live="off"
            ...
            <div class="swiper-slide hero-slider-one swiper-slide-prev" role="group" aria-label="1 / 3"
                style="width: 1195px; opacity: 1; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
                <div class="container">
                    <div class="col-lg-6">
            ...
            <div class="swiper-slide hero-slider-two swiper-slide-visible swiper-slide-active" role="group"
                aria-label="2 / 3"
                style="width: 1195px; opacity: 0.983264; transform: translate3d(-1215px, 0px, 0px); transition-duration: 0ms;">
                <div class="container">
                    <div class="col-lg-6">
            ...
            <div class="swiper-slide hero-slider-three swiper-slide-next" role="group" aria-label="3 / 3"
                style="width: 1195px; opacity: 0; transform: translate3d(-2430px, 0px, 0px); transition-duration: 0ms;">
                <div class="container">
                    <div class="col-lg-6">
                        <div class="wrapper-section">
                            <div class="wrapper-info">
    ...
    <div class="container">
        <div class="style-section">
            <div class="row gy-4 gx-5 gy-lg-0">
                <div class="col-lg-6">
                    <div class="product-wrapper wrapper-one aos-init aos-animate" data-aos="fade-right">
                        <div class="wrapper-info">
                ...
                <div class="col-lg-6">
                    <div class="product-wrapper wrapper-two aos-init aos-animate" data-aos="fade-up">
                        <div class="wrapper-info">
...
<section class="product-category">
    <div class="container">
        ...
        <div class="category-section">
            <div class="product-wrapper aos-init aos-animate" data-aos="fade-right" data-aos-duration="100">
            ...
            <div class="product-wrapper aos-init aos-animate" data-aos="fade-right" data-aos-duration="200">
                <div class="wrapper-img">
            ...
            <div class="product-wrapper aos-init aos-animate" data-aos="fade-right" data-aos-duration="300">
                <div class="wrapper-img">
            ...
            <div class="product-wrapper aos-init aos-animate" data-aos="fade-right" data-aos-duration="400">
                <div class="wrapper-img">
            ...
            <div class="product-wrapper aos-init aos-animate" data-aos="fade-right" data-aos-duration="500">
                <div class="wrapper-img">
            ...
            <div class="product-wrapper aos-init aos-animate" data-aos="fade-right" data-aos-duration="600">
                <div class="wrapper-img">
...
<!--------------- brand-section--------------->
<section class="product brand aos-init aos-animate" data-aos="fade-up">
    <div class="container">
        <div class="section-title">
                            ...
                            <div class="product-cart-items">
                                ...
                                <a href="wishlist.html" class="favourite cart-item">
                                    <span>
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <rect width="40" height="40" rx="20" fill="#5aa2d1"></rect>
                                            <path
